...
def callback_query(call):
    try:
        ...
        if call.data == "profile":
            ...
            markup = telebot.types.InlineKeyboardMarkup()
            btn_referral = telebot.types.InlineKeyboardButton("🔗  الإحالة", callback_data="referral_invite")
            btn_agency = telebot.types.InlineKeyboardButton("🏢  الوكالة", callback_data="agency")
